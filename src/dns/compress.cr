module DNS::Compress
  ...
  def self.decode!(protocol_type : ProtocolType, io : IO, buffer : IO::Memory, maximum_depth : Int32 = 65_i32) : String
    ...
    depth_decode_by_pointer! protocol_type: protocol_type, buffer: buffer, offset: before_buffer_pos, maximum_depth: maximum_depth
  end
  ...
  private def self.depth_decode_by_pointer!(protocol_type : ProtocolType, buffer : IO::Memory, offset : Int, maximum_depth : Int32 = 65_i32) : String
    before_buffer_pos = buffer.pos
    buffer.pos = offset
    ...
    while !(depth -= 1_i32).zero?
      ...
      if flag.pointer?
        next update_chunk_pointer_position protocol_type: protocol_type, buffer: buffer, chunk_length: chunk_length
      end
  ...
  private def self.update_chunk_pointer_position(protocol_type : ProtocolType, buffer : IO::Memory, chunk_length : UInt8)
    offset_buffer = uninitialized UInt8[1_i32]
