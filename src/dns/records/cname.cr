struct DNS::Records
  struct CNAME < Records
    ...
    def self.from_io(name : String, protocol_type : ProtocolType, io : IO, buffer : IO::Memory, options : Options = Options.new, maximum_length : UInt16 = 512_u16) : CNAME
      ...
      canonical_name = Compress.decode_by_length! protocol_type: protocol_type, io: io, length: data_length, buffer: buffer, options: options, maximum_length: maximum_length
