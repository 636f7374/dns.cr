struct DNS::Records
  struct NS < Records
    ...
    def self.from_io(name : String, protocol_type : ProtocolType, io : IO, buffer : IO::Memory, maximum_depth : Int32 = 65_i32, maximum_length : UInt16 = 512_u16) : NS
      ...
      name_server = Compress.decode_by_length! protocol_type: protocol_type, io: io, length: data_length, buffer: buffer, maximum_depth: maximum_depth, maximum_length: maximum_length
